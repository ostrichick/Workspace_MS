									...
									.ajax({
										...
										success : function(data) {
											if (data == "N") {
												...
												alert("회원등급 수정 성공!");
												$(id_input).attr("disabled",
														true);
											}
										},
										error : function(error) {
											alert("회원등급 수정 중 에러발생");
										}
									});
...
<body>
	...
	<div id="container" style="float: left;">
		...
		<table border="1px">
			...
			<c:forEach var="memberVo" items="${memberList}">
				<tr>
					...
					<td><input type="text" id="member_grade${memberVo.member_idx}"
						value="${memberVo.member_grade}" size="5" /></td>
					<td><button class="adminUpdateInfo"
							name="${memberVo.member_idx}">수정하기</button></td>
		...
		<a href="${pageContext.request.contextPath}/admin/index.do">관리자
			메인페이지</a>
	</div>
