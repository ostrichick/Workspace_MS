...
<body>
	...
	<form action="${pageContext.request.contextPath}/join_process.do"
		method="post">
		<!-- 폼 입력값을 서버로 전송하면 서버에서는 DispatcherServlet이 요청을 받아서
		HandlerMapping에게 요청을 처리할 Controller가 어디있는지 확인, 그 정보를 DispatcherServlet으로 돌려줌
		DS는 받은 정보를 이용해 Controller에게 요청 보냄.
		요청을 받은 Controller는 자신이 가지고있는 요청처리 메소드를 실행 -->
		...
		<div id="container" style="float: left; width: 250px;">
			...
			<div class="row mb-3">
				<div class="col-sm-15">
					<input type="text" class="form-control" id="member_handphone"
