...
<div class="link_container">
	...
	<div class="container-fluid" style="float:left;width:400px;">
	 ...
	 <div style="text-align:right">
		...
		<a href="${pageContext.request.contextPath}/board/insert.do">
	...
	<c:choose>
		...
		<c:otherwise>
				<c:forEach var="boardVo" items="${boardList}">
					<tr>
						<td>${boardVo.writer_id}</td><td>${boardVo.board_title}</td><td>${boardVo.board_content}</td>
						<td>${boardVo.board_addr}</td><td>${boardVo.board_price}</td><td>${boardVo.board_reg_date}</td>
					</tr>
					<tr>
						<td colspan="6">
